...
# Büyük resimler bu sınırın üstündeyse oranı bozulmadan küçülür.
MAX_WIDTH = 1600
MAX_HEIGHT = 1600

# Watermark ayarları
# Logo her resimde sabit piksel genişliğine yakın olur.
LOGO_TARGET_WIDTH = 360

# Logo zaten opaklığı ayarlanmış PNG ise 1.0 kalsın.
# Kodla ekstra şeffaflaştırmak istersen 0.30 yap.
LOGO_OPACITY = 1.0
...
def main():
    if not LOGO_PATH.exists():
        print("Hata: logo.png bulunamadı.")
        print("watermark.py ile aynı klasöre logo.png koymalısın.")
        return
    ...
    for folder in BASE_DIR.iterdir():
        ...
        # Ana klasörde yanlışlıkla watermark klasörü varsa atla
        if folder.name.lower() == "watermark":
            continue
